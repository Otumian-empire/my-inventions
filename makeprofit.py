...
# 	the percentage of the marked-up price, and the sales tax rate. 
# 	The program then outputs the original price of the item, the percentage 
# 	of the mark-up, the store’s selling price of the item, 
# 	the sales tax rate, the sales tax, and the final price of the item. 
...
# 	output: original price, percentage of the mark-up, selling price and sales
#	tax rate
